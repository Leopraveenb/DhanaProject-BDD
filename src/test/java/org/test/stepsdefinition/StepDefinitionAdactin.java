package org.test.stepsdefinition;
...
import com.test.POM.AdactinConfirmationPage;
import com.test.POM.AdactinHotelselection;
import com.test.POM.AdactinLoginPage;
import com.test.POM.Adactinbuttonpage;
...
@Then("Successfully Validate the Select Hotel")
  ...
  //Tc02 Login without user name
    ...
    public void validate_the_location_exception_message() throws InterruptedException {
	    ...
	    String location = "";
	    if (location.isEmpty()) {
	        System.out.println("Location is intentionally empty");
	    } else {
	    	hotelPage.Dropdownbyvisible(hotelPage.getLocation(), location);
	    }
	    }
