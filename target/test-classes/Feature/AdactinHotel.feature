...
Scenario Outline: TC03 - Booking without location and validate exception
  ...
  Examples:
    ...
    | dhanas37 | 542389   |          | Hotel Creek | Standard | 1 - One       | 25/08/2026  | 26/08/2026   | 2 - Two | 1 - One  |
 Scenario Outline: TC04 - Payment without CVV and validate exception
  ...
  Examples:
    | username | password | location | hotels      | roomtype | numberofrooms | checkindate | checkoutdate | adults  | children | Firstname | Lastname | billingAddress | cardNumber       | cardType | expMonth | expYear | cvv |
    | dhanas37 | 542389   | Sydney   | Hotel Creek | Standard | 1 - One       | 25/08/2026  | 26/08/2026   | 2 - Two | 1 - One  | Dhana     | Lakshmi  | Chennai        | 1234567890123456 | VISA     | January  | 2028    |     |
...
Scenario Outline: TC05 - Complete the booking and store the Order ID in a List
  ...
  Examples:
    | username | password | location | hotels      | roomtype | numberofrooms | checkindate | checkoutdate | adults  | children | Firstname | Lastname | billingAddress | cardNumber       | cardType | expMonth | expYear | cvv |
    | dhanas37 | 542389   | Sydney   | Hotel Creek | Standard | 1 - One       | 25/08/2026  | 26/08/2026   | 2 - Two | 1 - One  | Dhana     | Lakshmi  | Chennai        | 1234567890123456 | VISA     | January  | 2028    | 123 |
